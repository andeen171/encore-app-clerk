...
export function Environment(name: string): BaseURL {
    return `https://${name}-my-app-rdp2.encr.app`
}
...
/**
 * Client is an API client for the my-app-rdp2 Encore application. 
 */
...
export namespace auth {
    ...
    export interface UserData {
        ...
        "email_addresses": clerk.EmailAddress[]
    }
    ...
    export class ServiceClient {
        ...
        public async GetUser(id: string): Promise<UserData> {
            ...
            const resp = await this.baseClient.callAPI("GET", `/user/${encodeURIComponent(id)}`)
            return await resp.json() as UserData
        }

        public async GetUsers(): Promise<GetUserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/user`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "my-app-rdp2-Generated-TS-Client (Encore/v1.41.4)";
        }
